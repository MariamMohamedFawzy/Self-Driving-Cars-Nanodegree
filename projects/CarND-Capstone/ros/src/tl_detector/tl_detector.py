...
class TLDetector(object):
    ...
    def get_closest_waypoint(self, x, y):
        ...
        # prev_point = self.waypoint_tree[closest_indx-1]
    ...
    def process_traffic_lights(self):
        ...
        #TODO find the closest visible traffic light (if one exists)
            ...
            for i, light_temp in enumerate(self.lights):
                light_position = self.get_closest_waypoint(stop_line_positions[i][0], stop_line_positions[i][1])
                d = light_position - car_position
                if d >= 0 and d < diff:
                    diff = light_position - car_position
